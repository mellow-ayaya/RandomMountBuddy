...
RandomMountBuddy_PreloadData.MountToFamily = {
    ...
    [2478] = "Fire Hawk",    -- Blazing Royal Fire Hawk
    -- ========================================================
    -- ELEMENTALS
    -- ========================================================
    ...
    [1414] = "Blanchy",    -- Sinrunner Blanchy
    ...
    [2116] = "Remembered Golden Gryphon",    -- Remembered Golden Gryphon
    ...
    [1653] = "Armored Ottuk",    -- Brown War OTTUKS
    [1655] = "Armored Ottuk",    -- Yellow War Ottuk
    [1654] = "Otterworldly Ottuk Carrier",    -- Otterworldly Ottuk Carrier
    ...
    [543] = "Clutches",    -- Clutch of Ji-Kun
    [1297] = "Clutches",    -- Clutch of Ha-Li
    ...
    [971] = "Flying Antoran Hound",    -- Antoran Charhound
    [972] = "Flying Antoran Hound",    -- Antoran Gloomhound
    ...
    [2117] = "Remembered Wind Rider",    -- Remembered Wind Rider
    [441] = "Spectral Wind Rider",    -- Spectral Wind Rider
    [2499] = "Void-Scarred Windrider",    -- Void-Scarred Windrider
...
RandomMountBuddy_PreloadData.FamilyDefinitions = {
    ...
    -- Jellyfishes
    ["Jelly"] = {
        superGroup = "Subaquatic Jellyfishes",
        traits = { hasMinorArmor = false, hasMajorArmor = false, hasModelVariant = false, isUniqueEffect = false },
    },
